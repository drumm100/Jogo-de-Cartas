...
public class AvailableCards{
	...
	cards.add( new Monster("dem1", 5, 9, 14, "demonios/demonio1/demonio1.jpg" ) );
    cards.add( new Monster("dem2", 1, 3, 5, "demonios/demonio2/demonio2.jpg" ) );
    cards.add( new Monster("dem3", 3, 8, 6, "demonios/demonio3/demonio3.jpg" ) );
    cards.add( new Monster("dem4", 2, 5, 6, "demonios/demonio4/demonio4.jpg" ) );
    cards.add( new Monster("Alfio", 1, 1, 5000, "demonios/demonio5/demonio5.png") );
    cards.add( new Monster("dem6", 2, 3, 9, "demonios/demonio6/demonio6.jpg" ) );
    cards.add( new Monster("dem7", 5, 8, 13, "demonios/demonio7/demonio7.jpg" ) );
