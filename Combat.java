public class Combat{	
	public static void atk(Card c1, Card c2){
		...
		if( c1.type()==Type.TIME && c2.type()==Type.POWER ||
			...
			bonus = 1.25;
		//cartas que ganham vantagem (bonus 1.25)
		    	 ...
		    	 c1.type()==Type.REALITY && c2.type()==Type.SOUL )
		   		bonus = 0.75;
		//cartas que ganham desvantagem (bonus 0.75)
		c2.setHP( (int)( c2.getHP()-( c1.getAtk()*bonus - c2.getDef()/4 ) ));
		//aqui precisamos notificar os observadores (a futura classe tabuleiro, provavelmente)
	}	
}
